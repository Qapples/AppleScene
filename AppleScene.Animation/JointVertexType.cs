    ...
    public struct JointVertexType : IVertexType
    {
        ...
        static JointVertexType()
        {
            ...
            VertexDeclaration = new VertexDeclaration(
                new VertexElement(offset += 12, VertexElementFormat.Vector3, VertexElementUsage.Position, 0),
                new VertexElement(offset += 12, VertexElementFormat.Vector3, VertexElementUsage.Normal, 0),
                new VertexElement(offset += 8, VertexElementFormat.Vector2, VertexElementUsage.TextureCoordinate, 0),

                //BlendIndices in this case refer to the joints.
                new VertexElement(offset += 8, VertexElementFormat.Short4, VertexElementUsage.BlendIndices, 0),
                new VertexElement(offset += 16, VertexElementFormat.Vector4, VertexElementUsage.BlendWeight, 0));
        }
    }
}